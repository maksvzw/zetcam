 ...
 */
public final class DoubleSampleFifoBuffer extends AudioSampleFifoBuffer<Double>
{
    private final double[] tempBuf;
    
    protected DoubleSampleFifoBuffer(AudioFormat format, IAudioSamples samples) 
    {
